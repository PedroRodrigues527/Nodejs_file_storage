...
app.post("/createUser", (req, res) => {
  ...
  res.render(__dirname + "/view/connection.html", {
...
app.get("/mainmenu", (req, res) => {
  if (!auth) {
    ...
    res.render(__dirname + "/view/main.html", {
      username: username,
      Hostip: Hostip,
      userIp: userIp,
    });
...
app.get("/contentHtml", (req, res) => {
  ...
  res.render(__dirname + "/view/content.html", {
    fileText: fileText,
...
app.post("/uploadFile", (req, res) => {
  if (auth) {
    if (req.files) {
      ...
      req.files.file.mv(
        __dirname + "/uploads/" + req.files.file.name,
        function (err) {
          //192.168.0.X./uploads?
